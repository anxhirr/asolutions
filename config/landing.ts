...
export const infos: InfoLdg[] = [
  {
    ...
    description:
      "Unlock the Full Potential of Your Business with Our Comprehensive Suite of Tools, Designed to Streamline Operations and Drive Growth",
    image: "/_static/illustrations/work-from-home.jpg",
    list: [
      {
        title: "Inventory Management",
        description:
          "Track stock levels in real-time, automate reordering, and reduce waste.",
        icon: "laptop",
      },
      {
        title: "Sales Tracking",
        description:
          "Monitor sales performance, identify trends, and improve your sales strategy.",
        icon: "settings",
      },
      {
        title: "Reporting and Analytics",
        description:
          "Gain insights into your business operations with comprehensive reports and dashboards.",
        icon: "search",
      },
    ],
  },
